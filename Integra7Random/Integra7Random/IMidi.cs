...
namespace Integra7Random
{
    public interface IMidi
    {
        void Init(Integra7Random.MainPage mainPage, String deviceName, Picker OutputDeviceSelector, Picker InputDeviceSelector, object DeviceSpecificObject, byte MidiOutPortChannel, byte MidiInPortChannel);
