...
namespace Integra7Random.UWP
{
    public class MIDI : IMidi, IGenericHandler
    {
        ...
        public Integra7Random.MainPage mainPage { get; set; }
        ...
        public MIDI(Integra7Random.MainPage mainPage, Picker OutputDeviceSelector, Picker InputDeviceSelector, byte MidiOutPortChannel, byte MidiInPortChannel)
        {
        ...
        public MIDI(Integra7Random.MainPage mainPage, MainPage mainPage_UWP, Picker OutputDeviceSelector, Picker InputDeviceSelector, byte MidiOutPortChannel, byte MidiInPortChannel)
        {
        ...
        public void Init(Integra7Random.MainPage mainPage, String deviceName, Picker OutputDeviceSelector, Picker InputDeviceSelector, object Dispatcher, byte MidiOutPortChannel, byte MidiInPortChannel)
        {
            this.mainPage = mainPage;
        ...
        public void Init(String deviceName, Integra7Random.MainPage mainPage)
        {
            this.mainPage = mainPage;
            Init(deviceName);
        }

        public void Init(String deviceName, Integra7Random.MainPage mainPage, Picker OutputDeviceSelector, Picker InputDeviceSelector)
        {
            this.mainPage = mainPage;
